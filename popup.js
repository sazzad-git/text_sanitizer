...
const DEFAULT_WORDS = {
  ...
  "video calls": "vid-eo c-alls",
  "google meet": "g-meet",
  "google meets": "g-meets",
  anydesk: "any-desk",
  teamviewer: "team-view-er",
  rustdesk: "rust-desk",
  "rust desk": "ru-st-de-sk",
  remotely: "remo-tely",
  payment: "pa-yment",
  payments: "pa-yments",
  paypal: "p-ay-pal",
  ...
  cryptos: "cry-ptos",
  crypto: "cry-pto",
  cryptocurrency: "cry-ptocurrency",
  cryptocurrencies: "cry-ptocurrencies",
  bitcoin: "bi-t-co-in",
  bitcoins: "bi-t-co-ins",
  btc: "bt-c",
  "b-t-c": "bt-c",
  "b t c": "bt-c",
  wire: "wi-re",
  bank: "ba-nk",
  transfer: "trans-fer",
  "bank transfer": "ba-nk-trans-fer",
  "bank-transfer": "ba-nk-trans-fer",
  bankaccount: "ba-nk-accou-nt",
  "bank account": "ba-nk-accou-nt",
  "bank-account": "ba-nk-accou-nt",
  transfers: "trans-fers",
  cash: "ca-sh",
  invoice: "invo-ice",
  outside: "outsi-de",
  direct: "dire-ct",
  ...
  "trustpilots": "trust-pilots",
  "google review": "google-rev",
  "google reviews": "google-revs",
  followers: "follo-wers",
  subscribers: "subs-cribers",
  "five star": "5-st-ar",
  positive: "posi-tive",
  recommendation: "recomm-end",
  recommendations: "recomm-endations",

  password: "pass-word",
  login: "lo-gin",
  credential: "creden-tial",
  credentials: "creden-tials",
  address: "addr-ess",
  location: "loca-tion",
  locations: "loca-tions",
  private: "pri-vate",
  privates: "pri-vates",
  access: "acc-ess",
